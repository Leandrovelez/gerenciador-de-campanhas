...
-- Copiando estrutura do banco de dados para gerenciador_de_campanhas
CREATE DATABASE IF NOT EXISTS `gerenciador_de_campanhas` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */;
USE `gerenciador_de_campanhas`;
